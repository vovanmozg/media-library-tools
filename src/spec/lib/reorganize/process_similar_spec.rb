...
describe ProcessSimilar do
  ...
  it 'returns files from new_dir which similar in existing' do
    image1 = image(name: '1 identical.jpg', phash: 11111111111111111111, partial_md5: '1f1f1f1f1f1f1f1f1f1f1f1f1f1f1f')
    ...
    image4 = image(name: '3.jpg', phash: 33333333333333333333, partial_md5: '3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f')
    existing_data = {
      ...
      new_similar: [
        {
          ...
          to: '/dups/new_similar/x/1 identical.jpg',
