...
#     expected = [
#       '# Summary:',
#       '#   Identical files inside new dir: 2',
...
#       '##################################',
#       '# original: /vt/new/x/1 another identical.mp4 len: 4.4, 250x250 (ratio 1.0), size: 8359, 2020-09-13 12:26:40',
#       '# dup: len: 4.4, 250x250 (ratio 1.0), size: 8359, distance: 3, 2020-09-13 12:26:40',
#       "mkdir -p '/vt/dups/new_inside_full_dups/x'",
#       "mv '/vt/new/x/1.mp4' '/vt/dups/new_inside_full_dups/x/1.mp4'",
#       '',
#       '# original: /vt/new/x/1 another identical.mp4 len: 4.4, 250x250 (ratio 1.0), size: 8359, 2020-09-13 12:26:40',
#       '# dup: len: 4.4, 250x250 (ratio 1.0), size: 8359, distance: 3, 2020-09-13 12:26:40',
#       "mkdir -p '/vt/dups/new_inside_full_dups/x'",
#       "mv '/vt/new/x/1 identical.mp4' '/vt/dups/new_inside_full_dups/x/1 identical.mp4'",
#       ''
#     ]
#
...
#
#
#     cmds = described_class.new(
#       system: :linux,
#       new_dir: '/new',
#       dups_dir: '/dups',
#       real_new_dir: '/real/new',
#       real_dups_dir: '/real/dups'
#     ).process(actions_groups: actions)
#     expected = [
#       '# Summary:',
#       '#   Identical files inside new dir: 0',
#       '#   Similar files inside new dir: 0',
...
#       '#########################################',
#       '# original: /real/new/x/1.mp4 len: 57.91, 640x640 (ratio 1.0), size: 8464175, 2018-12-31 06:46:34',
#       '# dup: len: 59.048, 480x480 (ratio 1.0), size: 5708740, distance: 14, 2018-12-02 22:58:19',
#       "mkdir -p '/real/dups/new_inside_similar_doubtful/x'",
#       "mv '/new/x/2.mp4' '/real/dups/new_inside_similar_doubtful/x/2.mp4'",
#       '',
#     ]
#
#     expect(cmds).to eq(expected)
...
#   end
#
#   it 'converts new_full_dups'
#   it 'converts new_similar'
# end
